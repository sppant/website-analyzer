...
ALTER TABLE "analyses" ADD COLUMN "project_id" uuid;--> statement-breakpoint
...
CREATE INDEX "analyses_project_id_created_at_idx" ON "analyses" USING btree ("project_id","created_at");