      ...
      <div className="footer-inner">
        ...
        <nav className="footer-links" aria-label="Footer navigation">
          <div>
            ...
            <Link href="/serp-preview">SERP Preview</Link>
          ...
          <div>
            ...
            >
              <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
                <path d="M6.94 8.5H3.56V20h3.38V8.5ZM5.25 3A2 2 0 1 0 5.25 7a2 2 0 0 0 0-4ZM20.44 13.42c0-3.46-1.84-5.07-4.29-5.07-1.97 0-2.85 1.08-3.34 1.84V8.5H9.44V20h3.37v-5.69c0-1.5.28-2.95 2.14-2.95 1.83 0 1.86 1.71 1.86 3.05V20h3.63v-6.58Z" />
              </svg>
            </a>
          </div>
        </nav>
